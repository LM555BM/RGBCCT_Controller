...
ESP_NOW_BASE::ESP_NOW_BASE(uint8_t* loopState, std::vector< LED >* ledVector)
  : main_state{ loopState }, lights{ ledVector }
{
}
...
ESP_NOW_MASTER::ESP_NOW_MASTER(uint8_t* loopState, std::vector< LED >* ledVector)
  : ESP_NOW_BASE(loopState, ledVector)
{
  stateSelf = MASTER;
...
ESP_NOW_SLAVE::ESP_NOW_SLAVE(uint8_t* loopState, std::vector< LED >* ledVector)
  : ESP_NOW_BASE(loopState, ledVector)
{
  stateSelf = SLAVE;
